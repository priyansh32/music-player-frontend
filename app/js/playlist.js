const playlistdata = document.querySelector('.playlist-main')
var myplaylist = [
    {
        song_name: "Mirage",
        artist: "Oreo",
...
myplaylist.forEach((song, index) => {
    ...
    <svg class="likesvg" height="18" width="20" xmlns:svgjs="http://svgjs.com/svgjs"
...
<g id="SvgjsG1013">
    ...
    playlistdata.innerHTML += songdiv;
})